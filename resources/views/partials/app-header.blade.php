         ...
         <div class="w-full flex items-center justify-end ms-auto md:justify-between gap-x-1 md:gap-x-3">
             ...
             <div class="hidden md:block">
                 ...
                 <div class="relative">
                     ...
                     <input type="text"
                         class="py-2 ps-10 pe-16 block w-full bg-white border-gray-200 rounded-lg text-sm focus:outline-hidden focus:border-neutral-500 focus:ring-neutral-500 checked:border-neutral-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-800 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder:text-neutral-400 dark:focus:ring-neutral-600"
                         placeholder="Search">
                     <div class="hidden absolute inset-y-0 end-0 flex items-center pointer-events-none z-20 pe-1">
                         <button type="button"
                             class="inline-flex shrink-0 justify-center items-center size-6 rounded-full text-gray-500 hover:text-neutral-600 focus:outline-hidden focus:text-neutral-600 dark:text-neutral-500 dark:hover:text-neutral-500 dark:focus:text-neutral-500"
                             aria-label="Close">
