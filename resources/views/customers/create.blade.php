    ...
    <form method="POST" action="{{ route('customers.store') }}">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <div>
                        ...
                        <x-input id="phone_number" type="tel" autocomplete="phone_number"
                            placeholder='Customer Phone Number' value="{{ old('phone_number') }}" name='phone_number'
                            class="@error('phone_number') border-red-500  @enderror" />
                        <x-input-error for='phone_number' />
                    </div>

                    <div>
                        <x-label for='industry' required="true"> Industry</x-label>
                        <x-input id="industry" type="text" autocomplete="industry" placeholder='Customer Industry'
        ...
        <x-card>
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div>
                    <x-label for='lead_source_id' required="true">Lead Source </x-label>
        ...
        <div class="mt-4 grid justify-between">
            ...
            <button type="submit"
                class="flex  w-40 justify-center items-center  bg-indigo-600 px-3 py-1.5 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Save
